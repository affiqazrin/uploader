...
class StatementProcessor:
    ...
    def convert_columns_to_float(self, convert_lst):
        """
    ...
    def process_data(self, df, insg_to_insx, sheet, cycle, month):
        ...
        for col in self.params_cols:
            ...
            if self.params_cols[col] not in df_filtered.columns:
                df_filtered.loc[:, self.params_cols[col]]=''
        ...
        self.params_cols={
            ...
            'insx_row_count': df_filtered2.shape[0],
        ...
        df_filtered.loc[:, 'insx_month']=self.params_cols['insx_month']
        df_filtered.loc[:, 'insx_cycle']=insg_to_insx['insg_cycle']
        df_filtered.loc[:, 'insx_version']=self.params_cols['insx_version']       
